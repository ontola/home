...
**Mixed pages** are even better.
Mixed pages show HTML to humans and RDF to computers.
For example, our project [Argu](https://argu.co) (an online democracy and discussion tool) has a REST API that works like this.
Visit a webpage (e.g. [argu.co/nederland/m/46](https://argu.co/nederland/m/46)).
...
Publishing your RDF as mixed pages means that your API mimics your web page structure.
This makes it really easy for others to understand your API and use your data.

A third way to share your data is through a **SPARQL** endpoint.
