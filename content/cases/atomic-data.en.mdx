...
- [**Atomic-Server**](https://crates.io/crates/atomic-server): a very fast database + server, written in Rust.
...
- [**@tomic/react**](https://www.npmjs.com/package/@tomic/react): library for React, see [template on codesandbox](https://codesandbox.io/s/atomic-data-react-template-4y9qu?file=/src/MyResource.tsx)
