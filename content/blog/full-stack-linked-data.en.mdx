...
How might a web application work if it exclusively uses [Linked Data](https://ontola.io/blog/what-is-linked-data/) (RDF) to communicate between server and client?
...
This proved to be a quick and effective way to start, but as time passed, we noticed more and more **limitations of this server-side approach**:
