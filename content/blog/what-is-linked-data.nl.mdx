...
![De Triples in een graaf weergegeven](/images/posts/tim_graph.svg)
...
De `<>` symbolen geven IRI's aan (links naar Resources) en de `""` symbolen geven _literal values_ aan (informatie zonder Resource).
