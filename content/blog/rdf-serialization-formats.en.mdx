...
date: "2019-06-29"
description: "Since RDF has a wide variety of serialization formats, it's hard to pick the best one. This post will help you to find out."
---

Contrary to some other data models, RDF is not bound by a single serialization format.
Triple statements (the data atoms of RDF) can be serialized in many ways, which leaves developers with a possibly tough decision: how should I serialize my [linked data](/blog/what-is-linked-data)?
