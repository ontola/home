...
description: "What is NextJS, and when should you work with it?"
cases: []
---
...
- **Works with virtually all back-ends**. NextJS works with various CMS systems and databases, such as Stripe, Contentful or any [RESTFul APIs](/en/blog/api-design)
