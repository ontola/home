...
So often you need another back-end for content management.

Some suitable options as back-ends are:

- Ruby on Rails](/en/tech/ruby-on-rails)
- Atomic Data](/en/tech/atomic-data)
